...
configurations = {
    1: dict(
        ...
        MODEL_ROOT = '../models/arcface', # the root to buffer your checkpoints
        LOG_ROOT = './log', # the root to log your train/val status
        # the root to resume training from a saved checkpoint
        BACKBONE_RESUME_ROOT='../models/arcface/backbone_ir50_asia.pth',
        # the root to resume training from a saved checkpoint
        HEAD_RESUME_ROOT='../models/arcface',
